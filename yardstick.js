...
fetch("data.json").then((r)=>r.json()).then((data)=>{
  ...
  const steps = [
    ...
    { kind:"intro", kicker:"The end", headline:"The map is still <em>learning</em> the street.",
      narrative:`Of the ${surv.then} cafés mapped in ${surv.cohort}, ${surv.still} (${survPct}%) are still on the map — the rest churned, as streets and mapping both do. <a class='how' href='method.html#churn'>What "survival" means →</a> Three threads, one decade. <a class='how' href='street-life.html'>Back to Street Life →</a>` },
  ];
